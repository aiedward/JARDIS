...
#flags.DEFINE_string("data_dir", "./squad", "dataset directory [./squad]")
flags.DEFINE_string("data_dir", "./bAbI/en-10k", "dataset directory [./bAbI/en_valid]")
...
def main(_):
    ...
    train_stories, train_questions, max_words, max_sentences = read_data('{}/qa{}_single-supporting-fact_train.txt'.format(FLAGS.data_dir, FLAGS.babi_task), word2idx, max_words, max_sentences)
    valid_stories, valid_questions, max_words, max_sentences = read_data('{}/qa{}_single-supporting-fact_test.txt'.format(FLAGS.data_dir, FLAGS.babi_task), word2idx, max_words, max_sentences)
    test_stories, test_questions, max_words, max_sentences = read_data('{}/qa{}_single-supporting-fact_test.txt'.format(FLAGS.data_dir, FLAGS.babi_task), word2idx, max_words, max_sentences)
