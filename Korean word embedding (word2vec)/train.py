# -*- coding: utf-8 -*-
"""
Created on Wed Jul 12 14:42:04 2017
...
def train_and_test(root_train, root_test , output_name, params):
    ...
    directory = os.path.join("./models", datetime.now().strftime('%Y-%m-%d_%H-%M-%S'))
    os.makedirs(directory)
    test=open(directory+"/test results.txt","w")
    startTime = time.time()
...
if __name__ == "__main__":
    ...
    root_train = "./Data/Training data/text8"   
    root_test = "./Data/Test data/"
